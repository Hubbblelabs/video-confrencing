...
function VideoTileInner({
  ...
  return (
    <div
      className={`relative w-full h-full bg-[#1a1a1a] rounded-xl overflow-hidden flex items-center justify-center transition-all duration-200 group ${isActiveSpeaker
        ? 'ring-2 ring-blue-500 ring-offset-1 ring-offset-[#111] z-10'
