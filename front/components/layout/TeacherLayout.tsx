...
export function TeacherLayout({ children, currentView, onViewChange }: TeacherLayoutProps) {
    ...
    const getViewTitle = (view: string) => {
        switch (view) {
            ...
            case "class-history": return "Class History";
            default: return "My Classes";
        }
    };

    return (
        <SidebarProvider>
            <TeacherSidebar currentView={currentView} onViewChange={onViewChange} />
            <SidebarInset>
