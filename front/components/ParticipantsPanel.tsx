        ...
        <div className="flex items-center gap-3 p-2.5 rounded-lg hover:bg-white/[0.04] transition-colors group">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-white/40 font-semibold tracking-wider uppercase">(You)</span>
              {isHost && (
                <span className="text-[9px] px-1.5 py-0.5 rounded bg-blue-500/15 text-blue-400 font-bold tracking-wider uppercase">Host</span>
              )}
            </div>
          </div>
        </div>
          ...
          <div key={pUserId} className="flex items-center gap-3 p-2.5 rounded-lg hover:bg-white/[0.04] transition-colors group">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                {p.role === 'co_host' && (
                  <span className="text-[9px] px-1.5 py-0.5 rounded bg-teal-500/15 text-teal-400 font-bold tracking-wider uppercase">Co-Host</span>
                )}
              </div>
