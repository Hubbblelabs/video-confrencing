...
export function VideoGrid() {
  ...
  return (
    <div className="relative w-full h-full p-3 pt-16 pb-24 flex flex-col items-center justify-center">
      ...
      {/* Pagination Controls */}
      {totalPages > 1 && (
        <div className="absolute bottom-28 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-card/80 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.4)] z-50">
          <button
